...
import LogicModelActivitiesMatrix, {
  ActivityVertex,
...
const initialProjectInfoState: IProjectInfo<ECanadianSector> = {
  ...
  budgetItems: 22.0,
  budgetAct: 33.0,
  budgetFinanced: 150.0,
  solicitedBudget: 44.0,
  approvedBudget: 44.0,
...
const actmatrixGraphExample = new LogicModelActivitiesMatrix(
  vertexExample,
  edgesExample,
  actvitiesExample
);
...
const budgetItems: BudgetItem[] = [
  ...
  },
  {
    ...
    values: { unit: "personas", price: 3.05, amount: 1 },
  },
  {
    id: "1.1.2",
    name: "Personal administrativo y de apoyo",
    values: { unit: "personas", price: 5.45, amount: 3 },
  },
  {
    id: "1.2",
  ...
  },
  {
    ...
    values: { unit: "personas", price: 2.0, amount: 1 },
  },
  {
    id: "1.3.2",
    name: "Local (personal para la Acción)",
    values: { unit: "personas", price: 10.0, amount: 1 },
  },
  {
    id: "1.3.3",
    name: "Participantes en seminarios/conferencias",
    values: { unit: "personas", price: 13.05, amount: 1 },
  },
];
